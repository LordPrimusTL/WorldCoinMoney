...
<html lang="en">
<head>
    <title>World Coin Crypto-Currency Trading</title>
</head>
<body>
<p>Hello {{$name}}, Thank You For Registering With Us </p>

@if($paytype==1)
    <p>Please find below the bank account details you will be making a deposit/transfer to for your School Fees payment.</p>
