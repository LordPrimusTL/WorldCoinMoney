...
@section('body')
    <div class="container " style="margin-top:150px;margin-bottom:100px;">
        ...
        <div class="col-md-offset-2 col-md-7 ">
            @if($t == 1)
                <form action="{{route('EOPP',['token' => encrypt(1)])}}" method="post" style="margin-left:50px;" id="Regform" enctype="multipart/form-data">
            ...
            @elseif($t == 2)
                <form action="{{route('EOPP',['token' => encrypt(2)])}}" method="post" style="margin-left:50px;" id="Regform" enctype="multipart/form-data">
