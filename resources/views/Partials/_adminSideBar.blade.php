<nav class="side-navbar">
    ...
    <ul class="list-unstyled">
        <li class="{{Request::is('admin/dashboard') ? "active" : " "}} {{count(\App\User::where('activated',0)->get()) > 0 ? 'alert-danger' : ''}}"> <a href="{{route('admin_dashboard')}}"><i class="fa fa-user"></i>&nbsp;Users</a></li>
        ...
        <li class="{{Request::is('admin/withdrawal') ? "active" : " "}}{{count(\App\Withdrawal::where('ts_id',3)->get()) > 0 ? 'alert-danger' : ''}}"> <a href="{{route('admin_with')}}"><i class="fa fa-send-o"></i>&nbsp;Withdrawals</a></li>
